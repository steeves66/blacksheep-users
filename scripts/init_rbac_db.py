...
# ⭐ AJOUTER CES LIGNES EN TOUT PREMIER
import sys
...
DEFAULT_PERMISSIONS = [
    ...
    },
    {
        ...
        "resource": "user",
        "action": "read",
        "description": "Permet de consulter les profils utilisateurs",
        "is_system": True,
    },
    {
        "name": "user.update",
        ...
        "resource": "user",
        "action": "update",
        "description": "Permet de modifier les comptes utilisateurs",
        "is_system": True,
    },
    {
        "name": "user.delete",
    ...
    {
        "name": "user.ban",
        "display_name": "Bannir des utilisateurs",
        "resource": "user",
        "action": "ban",
        "description": "Permet de bannir des utilisateurs",
        "is_system": True,
    },
    # Permissions posts/articles
    {
        "name": "post.create",
        "display_name": "Créer des posts",
        "resource": "post",
        "action": "create",
        "description": "Permet de créer de nouveaux posts",
        "is_system": True,
    },
    {
        "name": "post.read",
        "display_name": "Voir les posts",
        "resource": "post",
        "action": "read",
        "description": "Permet de consulter les posts",
        "is_system": True,
    },
    {
        "name": "post.update",
        "display_name": "Modifier des posts",
        "resource": "post",
        "action": "update",
        "description": "Permet de modifier ses propres posts",
        "is_system": True,
    },
    {
        "name": "post.update_any",
        "display_name": "Modifier tous les posts",
        "resource": "post",
        "action": "update_any",
        "description": "Permet de modifier n'importe quel post",
        "is_system": True,
    },
    {
        "name": "post.delete",
        "display_name": "Supprimer des posts",
        "resource": "post",
        "action": "delete",
        "description": "Permet de supprimer ses propres posts",
        "is_system": True,
    },
    {
        "name": "post.delete_any",
        "display_name": "Supprimer tous les posts",
        "resource": "post",
        "action": "delete_any",
        "description": "Permet de supprimer n'importe quel post",
        "is_system": True,
    },
    {
        "name": "post.publish",
        "display_name": "Publier des posts",
        "resource": "post",
        "action": "publish",
        "description": "Permet de publier des posts",
        "is_system": True,
    },
    # Permissions commentaires
    {
        ...
        "resource": "comment",
        "action": "create",
        "description": "Permet de commenter",
        "is_system": True,
    },
    {
        "name": "comment.moderate",
        "display_name": "Modérer les commentaires",
        "resource": "comment",
        "action": "moderate",
        "description": "Permet de modérer/supprimer les commentaires",
        "is_system": True,
    },
    # Permissions rôles et permissions
    {
        ...
        "resource": "role",
        "action": "manage",
        "description": "Permet de créer/modifier/supprimer des rôles",
        "is_system": True,
    },
    {
        ...
        "resource": "permission",
        "action": "manage",
        "description": "Permet de créer/modifier/supprimer des permissions",
        "is_system": True,
    },
    # Permissions système
    {
        ...
        "resource": "settings",
        "action": "manage",
        "description": "Permet d'accéder aux paramètres système",
        "is_system": True,
    },
    {
        "name": "logs.view",
...
async def display_summary(rbac_repo: UserRepository):
    ...
    for role in sorted(all_roles, key=lambda r: r.priority, reverse=True):
        ...
        logger.info(
            f"    Priority: {role.priority}, Users: {user_count}, Default: {'✓' if role.is_default else '✗'}"
        )
