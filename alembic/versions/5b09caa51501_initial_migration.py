...
Revision ID: 5b09caa51501
Revises: 
Create Date: 2025-11-01 09:26:41.444342
...
def upgrade() -> None:
    ...
    op.create_index('idx_security', 'sessions', ['ip_address', 'user_agent'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index('idx_security', table_name='sessions')
